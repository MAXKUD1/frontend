...
export async function getServerSideProps() {
  const res = await fetch('https://ae69-49-229-100-36.ngrok-free.app/api/users')
...
export default function Component({ posts }) {
  ...
  const handleDelete = async (id) => {
    //console.log("ID :", id);
    fetch('https://ae69-49-229-100-36.ngrok-free.app/api/users?id=' + id,{
    method: 'DELETE',
    })
    ...
    <div className="col-md-auto">
      {/* <div className="container">
        ...
        <br></br><br></br>
          ...
          <div align="right" ><button type="button" className="btn btn-success text-end"><Link href="./dashboard/fromuser">เพิ่มสมาชิก</Link></button> </div>
        </>
    )
  }
